<section>
    <div class="container">
      <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
        <p class="col-md-4 mb-0 text-body-secondary">© 2024 Jethros Barbie World, Inc</p>
        ...
        <ul class="nav col-md-4 justify-content-end">
          ...
          <li class="nav-item"><a href="<?= base_url().'products'?>" class="nav-link px-2 text-body-secondary">The Dollhouse</a></li>
        </ul>
      </footer>
    </div>
  </section>
